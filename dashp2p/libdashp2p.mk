...
INCLUDES = -I. -Impd -Iutil -Ixml -I/usr/include -I/usr/include/libxml2 -I../vlc/include
HEADERS = $(wildcard *.h mpd/*.h util/*.h xml/*.h)
#SOURCES = $(wildcard *.cpp mpd/*.cpp util/*.cpp xml/*.cpp)
SOURCES = Dashp2p.cpp DashHttp.cpp ThreadAdapter.cpp Utilities.cpp DebugAdapter.cpp Statistics.cpp HttpRequest.cpp MpdWrapper.cpp XmlAdapter.cpp \
