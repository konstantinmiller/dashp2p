/****************************************************************************
 * ControlLogicActionStartDownload.cpp                                      *
 ****************************************************************************
...
ControlLogicAction* ControlLogicActionStartDownload::copy() const
{
	...
	return new ControlLogicActionStartDownload(connId, contentIds_copy, urls, httpMethods);
}
...
string ControlLogicActionStartDownload::toString() const
{
	...
	list<dash::URL>::const_iterator        jt = urls.begin();
...
bool ControlLogicActionStartDownload::operator==(const ControlLogicActionStartDownload& other) const
{
	...
	{
		list<dash::URL>::const_iterator it = urls.begin();
		list<dash::URL>::const_iterator jt = other.urls.begin();
